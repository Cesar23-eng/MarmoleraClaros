        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Direccion = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Nit_Ci = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FechaRegistro = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TipoCobro = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TotalFinal = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlantillaUsada = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    AreaCalculadaM2 = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    SubtotalMaterial = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesGeometria", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetallesGeometria_Materiales_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materiales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetallesGeometria_Pedidos_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DetalleGeometriaId = table.Column<int>(type: "int", nullable: false),
                    ServicioExtraId = table.Column<int>(type: "int", nullable: false),
                    Cantidad = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    SubtotalExtra = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetallesExtras", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetallesExtras_DetallesGeometria_DetalleGeometriaId",
                        column: x => x.DetalleGeometriaId,
                        principalTable: "DetallesGeometria",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallesExtras_ServiciosExtras_ServicioExtraId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "3", null, "Produccion", "PRODUCCION" },
                    { "4", null, "Contabilidad", "CONTABILIDAD" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesExtras_DetalleGeometriaId",
                table: "DetallesExtras",
                column: "DetalleGeometriaId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesExtras_ServicioExtraId",
                table: "DetallesExtras",
                column: "ServicioExtraId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesGeometria_MaterialId",
                table: "DetallesGeometria",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_DetallesGeometria_PedidoId",
                table: "DetallesGeometria",
                column: "PedidoId");
